...
class MainWindow(QMainWindow):
    ...
    def main_menu(self):
        ...
        tools = [
            ...
            ("Glue End to End Merge", "Merge subtitles end to end."),
            ("Stacked Merge", "Merge subtitles in a stacked manner."),
    ...
    def tool_selected(self, tool_name):
        ...
        elif tool_name == "Glue End to End Merge":
            from tools.glue_end_to_end_merge import GlueEndToEndMerge
            self.load_tool(GlueEndToEndMerge)
        elif tool_name == "Stacked Merge":
            from tools.stacked_merge import StackedMerge
            self.load_tool(StackedMerge)
        else:
