...
class NotificationBar(QWidget):
    def __init__(self, parent=None):
        ...
        self.notifications = [
            ("💡", "Tip: Merge multiple SRT files into one."),
            ("🎉", "New Feature: Try the Multilingual Merge tool!"),
            ("⏰", "Reminder: You last used Subtitle Shifter 2 days ago."),
            ("📰", "News: Check out our latest blog post!"),
            ("⏰", "Reminder: Use Longer Appearance for better readability."),
            ("💡", "Tip: Longer Appearance helps viewers read subtitles."),
            ("🎉", "New Feature: Combine subtitle files with Merge SRT."),
            ("📚", "Did you know? you can merge subtitles from different sources."),
            ("🔄", "Tip: Convert any subtitle format with ease."),
            ("💡", "Tip: Convert unsupported formats to .srt first."),
            ("🎬", "Reminder: Sync subtitles with Subtitle Shifter."),
            ("⏰", "Reminder: Shift subtitles to match video timing."),
            ("📂", "Tip: Open multiple tools at once."),
            ("💾", "Reminder: Don’t forget to save your changes!"),
            ("📋", "Supported Formats: 10+ formats like .srt, .ass, .vtt."),
            ("🌐", "Tip: Convert uncommon formats to .srt."),
            ("🤝", "Contribute: Check guidelines on GitHub!"),
            ("🌟", "Like Subtl? Star us on GitHub!"),
            ("📢", "News: macOS/Linux installers coming soon!"),
            ("🙏", "Thanks to all contributors!"),
            ("🛠", "Built with ❤️ by SubtlDevTeams.")
        ]
