...
from subtitleconverter.vtt_converter import convert_to_vtt
...
class SubtitleConverter(QWidget):
    ...
    def init_ui(self):
        ...
        # Convert button
        convert_button = QPushButton("Convert to VTT")
    ...
    def convert_subtitle(self):
        ...
        for index in range(self.file_list.count()):
            ...
            save_path, _ = QFileDialog.getSaveFileName(self, "Save Converted File", "", "VTT Files (*.vtt)")
            if not save_path:
                continue
            ...
            try:
                ...
                # Convert the content to VTT
                converted_content = convert_to_vtt(content, target_format)
        ...
        QMessageBox.information(self, "Success", "Subtitle files converted to VTT successfully!")